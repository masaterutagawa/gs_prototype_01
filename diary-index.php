...
// 変数をバインドあら
$stmt->bindValue(':registration_date', $registration_date, PDO::PARAM_STR); // Integer（数値の場合は PDO::PARAM_INT）
$stmt->bindValue(':created_date', $created_date, PDO::PARAM_STR); // Integer（数値の場合は PDO::PARAM_INT）
$stmt->bindValue(':update_date', $update_date, PDO::PARAM_STR); // Integer（数値の場合は PDO::PARAM_INT）
...
$stmt->bindValue(':events_points', $events_points, PDO::PARAM_STR); // Integer（数値の場合は PDO::PARAM_INT）
...
$stmt->bindValue(':photo_points', $photo_points, PDO::PARAM_STR); // Integer（数値の場合は PDO::PARAM_INT）
